...
/* =========================================================
   LIVE PHOTO ALBUM UPDATES
   INSERT / UPDATE / DELETE
========================================================= */

let photoAlbumRealtimeChannel = null;
let photoAlbumRefreshTimer = null;


function refreshPhotoAlbumLive(){

    clearTimeout(photoAlbumRefreshTimer);

    photoAlbumRefreshTimer =
        setTimeout(function(){
...
function startPhotoAlbumRealtime(){
    ...
    /*
       Remove an older subscription first.
       This prevents duplicate live listeners.
    */

    if(photoAlbumRealtimeChannel){

        window.supabaseClient
            .removeChannel(
                photoAlbumRealtimeChannel
            );

        photoAlbumRealtimeChannel = null;
    }
        ...
        window.supabaseClient
            ...
            .on(
                ...
                function(payload){
                    ...
                    console.log(
                        'Photo album live change:',
                        payload.eventType,
                        payload
                    );

                    refreshPhotoAlbumLive();
                }
            )
            .subscribe(function(status){

                console.log(
                    'Photo album realtime status:',
                    status
                );
            });
}
